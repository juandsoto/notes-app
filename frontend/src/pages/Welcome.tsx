...
const Welcome = () => {
  return (
    ...
    >
      <div className="relative flex bg-slate-50 min-w-[90%] max-w-[90%] md:min-w-[70%] lg:min-w-[50%] 2xl:min-w-[40%] min-h-[60%] px-8 py-12 rounded-lg shadow-xl shadow-slate-500/50">
